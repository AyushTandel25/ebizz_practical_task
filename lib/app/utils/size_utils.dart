import '/../app/utils/navigation_utils.dart';
import 'package:flutter/material.dart';

dynamic getSize(double px) {
  return px * ((MathUtilities.screenWidth(NavigationUtilities.key.currentState!.overlay!.context)) / 414);
}
...
dynamic getPercentageWidth(double percentage) {
  return MathUtilities.screenWidth(NavigationUtilities.key.currentState!.overlay!.context) * percentage / 100;
}

dynamic getPercentageHeight(double percentage) {
  return MathUtilities.screenHeight(NavigationUtilities.key.currentState!.overlay!.context) * percentage / 100;
}
